#include <jni.h>
//#define ON_LOAD_ROUTINE void __attribute__((constructor))ON_LOAD_ROUTINE ()
//#define ON_UNLOAD_ROUTINE void __attribute__((constructor))ON_UNLOAD_ROUTINE ()
extern "C" {
/* filter.c
...
void __attribute__((destructor)) ON_UNLOAD_ROUTINE () {
